...
该仓库用于存放大连东软信息学院Python程序设计作业的相关代码（包括但不限于PTA和数据结构的实现）。需要注意的是，代码由本人完成，并不一定能保证最简化，仅供大家参考。如有更好的代码优化方案或其他想法，可以通过提交Issues或点击上方图标联系我。如果该项目对您有所帮助，您可以Star此项目用于表达对我的支持，谢谢！
